const loadCategory = async () => {
    ...
    data.data.forEach((category) => {
        ...
        div.innerHTML = `
            <button onclick="handleLoadCard('${category.category_id}')" class="bg-gray-200 px-5 py-2 rounded font-semibold focus:bg-red-500">${category.category}</button>
        `
        ...
        div.innerHTML = `
            <div>
                <img class="mx-auto" src="./img/Icon.png" alt="">
                    <h2 class="text-center text-3xl font-bold mt-8">Oops!! Sorry, There is no <br> content here</h2>
